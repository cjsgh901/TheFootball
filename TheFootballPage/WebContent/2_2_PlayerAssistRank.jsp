...
<title><%=chooseLeague %> Assist Ranking</title>
...
<%! Connection conn = null;
	...
	String sql = player.getSqlAssistRank();
	%>
<body>
...
<div class = "chartAssist" id="expertise" align = "center" style = " width:80%; position:relative;">
	<div style = "width : 680px; height : 80px; font-size:50px; color:#F3F3F3; background-color: rgba( 189, 189, 189, 0.3 );"><%=chooseLeague %> Assist Ranking</div>
		...
		<div style="width: 680px; height:90%; position:relative; background-color: rgba(189, 189, 189, 0.8); overflow:auto;">
			...
			<table style="position:relative; border:2px solid white;">
				...
				<tr>
						<p>
						<br>
						<td style="width:40px; color:white; background:black;text-align:center;">순위</td>
						 <td id = "scorebox" style="width:200px;color:white; background:black;">선수 이름</td>
						 <td id = "scorebox" style="width:35px;color:white; background:black;">도움</td>            
						 <td style="width:200px; color:white; background:black;text-align:center;">구단명</td>	
					</tr>
					
			<%
				conn = DriverManager.getConnection(url, user_id, user_pw);
				stmt = conn.createStatement();
				rs = stmt.executeQuery(player.getSqlAssistRank());
			...
			%>
					<tr>
						<td style="width:40px; color:#350038; background:#18F97A;text-align:right;"><%= rs.getInt("rank") %>&nbsp;</td>
						 ...
						 <td id = "scorebox" style="width:35px;color:white;background:#E2004F;"><%= rs.getInt("playerassist") %></td>
