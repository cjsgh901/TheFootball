				...
				<tbody>
					<form action="8_3_1_Inserttrade2.jsp" method="post" onsubmit="return check_input();">
						<tr>
							...
							<td><label>DATE</label>
							<input type="date" id="tradedate" name="tradedate" value="2021-01-01" style="width:135px;">
							</td>
						</tr>
						...
						<tr>
							<td>
								...
								<input type="text" id="preteam" name="preteam" value="" style="width:150px;">
							</td>
							<td>
						...
						<tr>
							<td>
								<label>TRADEPRICE(Great British Pound)</label>
								<input type="number" id="tradeprice_gbp" name="tradeprice_gbp" value="" min="0" step="1000">
							</td>
								<td style="width:300px;"><br><label>TRADE TYPE&nbsp;&nbsp;</label><br>
								<label><input type="radio" id="tradehappen" name="tradehappen" value="이적" checked>TRANSFER</label>
								<label><input type="radio" id="tradehappen" name="tradehappen" value="임대">LOAN</label><br>
								<label><input type="radio" id="tradehappen" name="tradehappen" value="방출">RELEASE</label>
								<label><input type="radio" id="tradehappen" name="tradehappen" value="은퇴">RETIREMENT</label>
							</td>
