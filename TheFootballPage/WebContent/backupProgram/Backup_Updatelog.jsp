...
<%! Connection conn = null;
	...
	String sql = backup.getSqlUpdateLog();
	%>
...
<div id = "expertise" class = "main"  align = "center" >
	<div style = "width: 1000px; font-size:50px; color:rgba( 255 , 255, 255, 0.8); background-color: rgba( 56, 0, 60, 0.8 );">UPDATE DB LOG</div>
			...
			<table>
				<tbody>
					...
					<%
						...
						rs = stmt.executeQuery(backup.getSqlUpdateLog());
					...
					%>
							<tr>
								...
								<td id = "scorebox" style="width:100px;color:#350038; background:#04F5FF;text-align:center;"><%= rs.getString("updatedate") %></td>
