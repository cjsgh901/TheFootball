...
<%! Connection conn = null;
	...
	String sql = backup.getSqlDeleteLog();
	%>
...
<div id = "expertise" class = "main"  align = "center" >
	<div style = "width: 1000px; font-size:50px; color:rgba( 255 , 255, 255, 0.8); background-color: rgba( 56, 0, 60, 0.8 );">DELETE DB LOG</div>
			...
			<table>
				<tbody>
							<tr>
								...
								<td id = "scorebox" style="color:white; background:black;">DELETE DATE</td>
							</tr>
					<%
						conn = DriverManager.getConnection(url, user_id, user_pw);
						stmt = conn.createStatement();
						rs = stmt.executeQuery(backup.getSqlDeleteLog());
					...
					%>
							<tr>
								...
								<td id = "scorebox" style="width:100px;color:#350038; background:#04F5FF;text-align:center;"><%= rs.getString("deletedate") %></td>
